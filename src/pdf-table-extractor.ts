      ...
      return page
        ...
        .then(function (opList) {
          ...
          while (opList.fnArray.length) {
            ...
            } else if (PDFJSOPS.save == fn) {
              transformStack.push(transformMatrix);
            } else if (PDFJSOPS.restore == fn) {
              transformMatrix = transformStack.pop();
            } else if (PDFJSOPS.transform == fn) {
              transformMatrix = transform_fn(transformMatrix, args);
            } else if (PDFJSOPS.setStrokeRGBColor == fn) {
              strokeRGBColor = args;
            } else if (PDFJSOPS.setFillRGBColor == fn) {
              fillRGBColor = args;
            } else if (PDFJSOPS.setLineWidth == fn) {
              lineWidth = args[0];
